...
<head>
    ...
    <style>
        :root { --bg: #f6fbff; --bg-accent: radial-gradient(circle at top left, rgba(14,165,233,.18), transparent 28%), radial-gradient(circle at bottom right, rgba(99,102,241,.16), transparent 26%), linear-gradient(180deg, #f7fbff 0%, #eef5ff 100%); --panel: rgba(255,255,255,.84); --panel-strong: rgba(255,255,255,.96); --border: rgba(148,163,184,.18); --text: #0f172a; --muted: #64748b; --soft: #e2e8f0; --accent: #2563eb; --accent-strong: #1d4ed8; }
        html.dark { --bg: #020617; --bg-accent: radial-gradient(circle at top left, rgba(37,99,235,.28), transparent 28%), radial-gradient(circle at bottom right, rgba(14,165,233,.18), transparent 24%), linear-gradient(180deg, #081121 0%, #020617 100%); --panel: rgba(7,18,36,.76); --panel-strong: rgba(9,16,31,.94); --border: rgba(148,163,184,.18); --text: #e2e8f0; --muted: #94a3b8; --soft: rgba(15,23,42,.82); --accent: #60a5fa; --accent-strong: #3b82f6; }
