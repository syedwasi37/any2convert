...
$tool_slugs = [
    ...
    'json_to_csv' => 'json-to-csv', 'csv_to_json' => 'csv-to-json', 'sql_to_json' => 'sql-to-json', 'qr_generator' => 'qr-code-generator',
...
$tools = [
    ...
    'convert' => [
        ...
        'tools' => [
            ...
            ['id' => 'json_to_csv', 'name' => 'JSON to CSV', 'icon' => 'json_to_csv', 'desc' => 'Convert JSON to CSV or Excel'],
            ['id' => 'csv_to_json', 'name' => 'CSV to JSON', 'icon' => 'csv_to_json', 'desc' => 'Convert CSV to JSON'],
            ['id' => 'sql_to_json', 'name' => 'SQL to JSON', 'icon' => 'sql_to_json', 'desc' => 'Convert SQL INSERT rows to JSON'],
...
<main id="tools" style="max-width:1280px;margin:0 auto;padding:0 20px 100px;">
    ...
    $iconSvgs = [
        ...
        'sql_to_json' => '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="5" rx="7" ry="3"/><path d="M5 5v14c0 1.7 3.1 3 7 3s7-1.3 7-3V5"/><path d="M5 12c0 1.7 3.1 3 7 3s7-1.3 7-3"/></svg>',
        // Utilities
...
function getToolName(toolId) {
    const names = {
        ...
        'csv_to_json':'CSV to JSON','sql_to_json':'SQL to JSON','qr_generator':'QR Code Generator','password_gen':'Password Generator',
