...
$tool_slugs = [
    ...
    'resize_image' => 'resize-image', 'crop_image' => 'crop-image', 'image_enhancer' => 'image-enhancer', 'ai_image_generator' => 'ai-image-generator',
...
<header style="position:relative;overflow:hidden;padding:80px 16px 72px;text-align:center;">
    ...
    <div style="position:relative;z-index:1;max-width:720px;margin:0 auto;">
        ...
        <p class="hero-sub" style="margin:20px auto 36px;">
            15+ professional-grade tools for PDF, documents, images, and more. Free forever, no account required.
        </p>
...
function getToolName(toolId) {
    const names = {
        ...
        'crop_image':'Crop Image','ai_image_generator':'AI Image Generator','ocr_tool':'OCR Tool',
