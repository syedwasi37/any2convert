        ...
        <div class="max-w-4xl mx-auto px-6 py-12 relative z-10">
            <div class="panel rounded-[2.75rem] p-8 md:p-12">
                ...
                <div class="space-y-6 text-slate-600 leading-relaxed font-medium mt-8">
                    ...
                    <p>We use analytics services to understand which pages are useful, which tools are failing, and how visitors move through the website. We may also use advertising technologies, including Google services, to support the site. These services may collect or receive information such as cookies, web beacons, IP addresses, browser details, device information, and interaction data according to their own policies and applicable law.</p>
                    <p>Third parties, including Google, may place and read cookies on your browser or use web beacons and IP addresses to collect information as a result of ad serving or measurement on this website. Depending on your region, consent banners or platform controls may affect whether personalized advertising technologies are used.</p>
                    <p>You can learn more about how Google uses information from partner sites and apps here: <a href="https://policies.google.com/technologies/partner-sites" class="text-blue-600 font-bold hover:underline" rel="noopener noreferrer" target="_blank">How Google uses information from sites or apps that use its services</a>.</p>
                    <p>Blocking cookies in your browser may affect some non-essential analytics, remembered preferences, or advertising functionality, but core pages should still remain usable.</p>
